...
func TestSecureHeaders(t *testing.T) {
	...
	// Pass the mock HTTP handler to our secureHeaders middleware. Because secureHeaders *returns* a http.Handler we can call it serveHTTP() method, passing in the http.ResponseREcoreder and dummy http.Request to execute it.
